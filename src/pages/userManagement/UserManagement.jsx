  ...
  return (
    <div className="user-management-page">
      ...
      <div className="um-filters">
        <input className="um-input" placeholder="Search items..." />

        <div className="um-select-wrapper-Permissions">
        ...
        <div className="um-select-wrapper-joined">
